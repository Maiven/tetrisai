  ...
  return (
    <main className="legalPage">
      ...
      <section>
        ...
        <p>현재 Share Link v1은 별도 애플리케이션 DB에 요청·응답을 저장하지 않는 stateless 방식입니다. 질문·답변 payload는 URL query가 아니라 <b>fragment(#)</b>에 담겨 일반 HTTP 요청의 URL로 서버에 전송되지 않도록 설계했습니다. 다만 <b>링크 자체를 가진 사람은 그 내용을 읽을 수 있고 브라우저 기록·클립보드 등에 남을 수 있습니다.</b> 비공개 재무·고객·계약·영업비밀은 응답 링크에 입력하면 안 됩니다.</p>
